...
<head>
    ...
    <link rel="icon" href="{{ url('/asset/sett.png') }}">
        ...
        <div class="container">
            ...
            <div id="my-nav" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    @can('role','admin')
                    <li class="nav-item">
                        <a href="{{ route('rooms.index') }}" class="nav-link">Room Status</a>
                    </li>
                    <li class="nav-item">
                        <a href="admin/rooms#control" class="nav-link">Room Control</a>
                    </li>
                    @endcan
                    <script>
                        document.getElementById("doubleLink").onclick = function () {
                            window.open("{{ route('rooms.index') }}");
                        } 
                    </script>
